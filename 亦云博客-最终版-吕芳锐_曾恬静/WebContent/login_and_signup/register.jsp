  ...
  <body style="background-color:#ab2526">
    ...
    <div class="biaoti">亦&emsp;云</div>
      <form class="form-signin">
        ...
        <input style="background-color:#f8d6d5" type="text" id="username" class="form-control" placeholder="Email address" required="" autofocus="">
        <label  for="inputPassword" class="sr-only">Password</label>
        <input style="background-color:#f8d6d5" type="password" id="password" class="form-control" placeholder="Password" required="">
        <div class="checkbox">
          <label>
            <input type="checkbox" value="remember-me"> Remember me
          </label>
        </div>
        <button onclick="register()" style="background-color:#ab2526;border-color:#ab2526"class="btn btn-lg btn-primary btn-block" type="submit">log in</button>
		
      </form>
	  <div class="sign">Don't have an account?<a href="sign_up.html">sign up</a></div>
