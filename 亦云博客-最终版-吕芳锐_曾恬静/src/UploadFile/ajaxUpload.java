...
public class ajaxUpload extends HttpServlet {
	...
	// 保存文件的目录
	private static String PATH_FOLDER = "/uploadFile/file";
	// 存放临时文件的目录
	private static String TEMP_FOLDER = "/uploadFile/uploadTemp";
	...
	public void init(ServletConfig config) throws ServletException {
		...
		// 初始化路径
		// 保存文件的目录
		PATH_FOLDER = servletCtx.getRealPath("/uploadFile/file");
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println("ajaxUpload 61 lines: go into ok");
		...
		try {
			...
			String picUrl = request.getContextPath()+"/uploadFile/file/"+saveName;
