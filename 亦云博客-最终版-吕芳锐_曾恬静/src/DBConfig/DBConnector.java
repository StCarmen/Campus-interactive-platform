...
public class DBConnector {
	...
	private static String url = "jdbc:mysql://183.174.60.33/yiyun?autoReconnect=true&amp;autoReconnectForPools=true&characterEncoding=UTF-8";
	private static String user = "root";
	private static String password ="web@ipv6";
